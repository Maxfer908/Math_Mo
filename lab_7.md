---
# Front matter
title: "Лаб.7 Задача об эпидемии"
...
При этом объем аудитории N=945, в начальный момент о товаре знает 13 человек. Для
...
При $a_1(t)>>a_2(t)$ получается модель типа модели Мальтуса.
...
Построили графики распространения рекламы.
